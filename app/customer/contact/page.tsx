            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 dark:border-slate-700">
                  ...
                  <th className="text-left py-3 px-4 font-semibold text-gray-800 dark:text-white">Phone</th>
              ...
              <tbody>
                {[
                  ...
                  { name: 'Jane Smith', email: 'jane@example.com', phone: '+1234567891', status: 'Active' },
                  { name: 'Bob Johnson', email: 'bob@example.com', phone: '+1234567892', status: 'Inactive' },
                ].map((contact, idx) => (
                  <tr key={idx} className="border-b border-gray-200 dark:border-slate-700">
                    <td className="py-3 px-4 text-gray-800 dark:text-white font-medium">{contact.name}</td>
