    ...
    <footer className="bg-white dark:bg-gray-900 text-gray-600 dark:text-gray-300 border-t border-gray-200 dark:border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-0">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* Company Info */}
          <div>
            <h3 className="text-gray-900 dark:text-white text-xl font-bold mb-4">Naad Official</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-4 leading-relaxed">
              Your trusted platform for spiritual guidance, horoscope readings, astrology insights, and divine services.
            </p>
            <div className="flex gap-4">
              <a href="#" className="text-gray-500 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors" aria-label="Facebook">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/horoscope" className="text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
                  Horoscope
                </Link>
              </li>
              <li>
          ...
          {/* Legal */}
          <div>
            <h3 className="text-gray-900 dark:text-white text-lg font-semibold mb-4">Legal</h3>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <Link href="/refund" className="text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
                  Refund Policy
                </Link>
              </li>
              <li>
                <Link href="/faq" className="text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
                  FAQ
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-purple-600 dark:text-purple-400 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@naadofficial.com" className="text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+911234567890" className="text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
                  +91 123 456 7890
                </a>
              </li>
              <li className="flex items-start gap-3">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-gray-200 dark:border-gray-800 pt-2.5 pb-2.5">
