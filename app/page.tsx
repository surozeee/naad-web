          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:block">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/80 dark:bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/30 dark:border-white/20">
                  <div className="text-4xl mb-3">♈</div>
                  <div className="text-3xl font-bold mb-1 text-gray-900 dark:text-white">12K+</div>
                  <div className="text-purple-100 dark:text-white text-sm">Daily Readings</div>
                </div>
                <div className="bg-white/80 dark:bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/30 dark:border-white/20">
                  <div className="text-4xl mb-3">⭐</div>
                  <div className="text-3xl font-bold mb-1 text-gray-900 dark:text-white">8K+</div>
                  <div className="text-purple-100 dark:text-white text-sm">Charts Generated</div>
                </div>
                <div className="bg-white/80 dark:bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/30 dark:border-white/20">
                  <div className="text-4xl mb-3">🖐️</div>
                  <div className="text-3xl font-bold mb-1 text-gray-900 dark:text-white">15K+</div>
                  <div className="text-purple-100 dark:text-white text-sm">Palm Readings</div>
                </div>
                <div className="bg-white/80 dark:bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/30 dark:border-white/20">
                  <div className="text-4xl mb-3">🕉️</div>
                  <div className="text-3xl font-bold mb-1 text-gray-900 dark:text-white">5K+</div>
                  <div className="text-purple-100 dark:text-white text-sm">Puja Services</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="w-full bg-gray-50 dark:bg-gray-900 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-purple-600 to-pink-600 dark:from-purple-800 dark:to-pink-800 rounded-xl p-8 shadow-lg text-white h-full flex flex-col justify-between">
              <div>
                <div className="text-6xl mb-4">✨</div>
                <h3 className="text-2xl font-bold mb-3 text-white dark:text-white">
                  Complete Platform
                </h3>
                <p className="text-purple-100 dark:text-white mb-4 leading-relaxed">
              ...
              <Link 
                href="/dashboard"
                className="inline-block px-6 py-3 bg-white dark:bg-white/10 text-purple-600 dark:text-white rounded-lg font-semibold hover:bg-gray-100 dark:hover:bg-white/20 transition-all transform hover:scale-105 dark:border dark:border-white/20"
              >
                View Dashboard →
              </Link>
            </div>
