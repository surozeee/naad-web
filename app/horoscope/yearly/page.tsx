      ...
      <div className="space-y-6">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Get comprehensive yearly predictions for all zodiac signs
          </p>
        </div>
            ...
            {['Aries', 'Taurus', 'Gemini', 'Cancer', 'Leo', 'Virgo', 'Libra', 'Scorpio', 'Sagittarius', 'Capricorn', 'Aquarius', 'Pisces'].map((sign) => (
              <div key={sign} className="bg-gray-50 dark:bg-slate-700 rounded-lg p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                  This year brings major life changes and opportunities. Focus on personal growth and 
                  spiritual development. Your hard work will be rewarded in unexpected ways.
                </p>
              </div>
            ))}
          </div>
