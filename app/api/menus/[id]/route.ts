...
export async function GET(
  ...
  try {
    ...
    if (!id) {
      return NextResponse.json({ message: 'Menu id required' }, { status: 400 });
    }
    ...
    console.error('[API menus get-by-id]', e);
...
export async function PUT(
  ...
  try {
    ...
    console.error('[API menus update]', e);
...
export async function PATCH(
  ...
  try {
    ...
    console.error('[API menus change-status]', e);
...
export async function DELETE(
  ...
  try {
    ...
    console.error('[API menus delete]', e);
