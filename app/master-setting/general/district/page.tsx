            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 dark:border-slate-700">
                  ...
                  <th className="text-left py-3 px-4 font-semibold text-gray-800 dark:text-white">District Name</th>
                  <th className="text-left py-3 px-4 font-semibold text-gray-800 dark:text-white">State</th>
              ...
              <tbody>
                {[
                  { id: 1, name: 'Mumbai', state: 'Maharashtra', status: 'Active' },
                  { id: 2, name: 'Pune', state: 'Maharashtra', status: 'Active' },
                  { id: 3, name: 'Ahmedabad', state: 'Gujarat', status: 'Active' },
                ].map((district) => (
                  <tr key={district.id} className="border-b border-gray-200 dark:border-slate-700">
                    <td className="py-3 px-4 text-gray-600 dark:text-gray-400">{district.id}</td>
                    <td className="py-3 px-4 text-gray-800 dark:text-white font-medium">{district.name}</td>
                    <td className="py-3 px-4 text-gray-600 dark:text-gray-400">{district.state}</td>
